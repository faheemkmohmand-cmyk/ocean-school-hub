  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (false as boolean) {
        ...
        // No pre-upload happened — create record and save doc URLs now
        ...
        // Save already-uploaded URLs to admission_documents
        const { supabase } = await import("@/lib/supabase");
        ...
        if (docs.length > 0) {
          await supabase.from("admission_documents").insert(docs);
        }
      }
