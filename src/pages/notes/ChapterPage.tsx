  ...
  return (
    <>
      ...
      <div className="mt-8" ref={containerRef}>
        ...
        {/* Iframe container — explicit height, no absolute tricks */}
        <div
          className="rounded-2xl overflow-hidden border-2 shadow-lg w-full"
          style={{ borderColor: `${subjectColor}40`, height: "clamp(320px, 75vw, 520px)" }}
        >
          <iframe
            key={iframeKey}
            srcDoc={srcDoc}
