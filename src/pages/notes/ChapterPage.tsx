...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// InteractiveIframe — uses blob: URL so parent-page CSP never blocks p5.js CDN
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
const InteractiveIframe = ({ code, subjectColor }: { code: string; subjectColor: string }) => {
  const [blobUrl, setBlobUrl] = useState<string>("");
  const [fsBlobUrl, setFsBlobUrl] = useState<string>("");
  const [frameKey, setFrameKey] = useState(0);
  const [fullscreen, setFullscreen] = useState(false);

  // Build blob URL whenever code changes.
  // Blob URLs have their OWN origin — completely immune to parent-page CSP.
  // This is the only 100% reliable way to run p5.js CDN inside an iframe
  // when the parent app has a strict Content-Security-Policy.
  useEffect(() => {
    if (!code?.trim()) return;
  ...
  const iStyle = { width: "100%", height: "100%", border: "none", display: "block" } as const;
