...
function buildSrcDoc(code: string): string {
  ...
  // Vanilla JS / Canvas fallback
  const safeVanilla = code.replace(/<\/script>/gi, "<\\/script>");
  return [
    '<!DOCTYPE html><html><head>',
    '<meta charset="utf-8">',
    '<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no">',
    '<style>*{margin:0;padding:0;box-sizing:border-box}html,body{width:100%;height:100%;overflow:hidden;background:#f8f9ff;font-family:system-ui,sans-serif}#c{width:100%;height:100%}canvas{display:block;touch-action:none}</style>',
