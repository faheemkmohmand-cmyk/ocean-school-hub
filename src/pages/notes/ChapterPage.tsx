...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// INTERACTIVE IFRAME — renders full HTML demos safely
// Admin pastes complete HTML (with CSS + JS + Canvas) — runs in sandboxed iframe
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
const InteractiveIframe = ({ code, subjectColor }: { code: string; subjectColor: string }) => {
  ...
  // If admin stored old JS-only code (not full HTML), wrap it automatically
  const isFullHtml = code.trim().toLowerCase().startsWith("<!doctype") || code.trim().toLowerCase().startsWith("<html");
  const srcDoc = isFullHtml ? code : `<!DOCTYPE html>
<html><head><style>
body{margin:0;padding:0;background:#f8f9ff;overflow:hidden;width:100%;height:100%}
canvas{display:block}
</style></head><body>
<div id="container" style="width:100%;height:100%;min-height:320px"></div>
<script>
const container = document.getElementById('container');
${code.replace(/__trackedInterval/g, "setInterval").replace(/__ti/g, "setInterval")}
</script></body></html>`;
    ...
    <>
      ...
      {fullscreen && (
        <div className="fixed inset-0 z-50 bg-black flex flex-col">
          ...
          <iframe key={`fs-${key}`} srcDoc={srcDoc} sandbox="allow-scripts allow-same-origin"
            className="flex-1 w-full" style={{border:"none"}} title="Interactive Demo Fullscreen" />
        </div>
      )}
      ...
      <div className="mt-8">
        ...
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-lg font-bold text-foreground flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl flex items-center justify-center" style={{backgroundColor:`${subjectColor}20`}}>
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => setExpanded(v => !v)}
              className="hidden sm:flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground px-3 py-1.5 rounded-xl border border-border hover:bg-secondary transition-colors">
        ...
        {/* iframe container */}
        <div className={`relative rounded-2xl overflow-hidden border-2 shadow-lg transition-all duration-300`}
          style={{
            borderColor: `${subjectColor}40`,
            height: expanded ? "600px" : "380px",
          }}>
          <iframe
            key={key}
            srcDoc={srcDoc}
        ...
        <p className="text-[10px] text-muted-foreground mt-1.5 flex items-center gap-1">
          ...
          Tip: Click Fullscreen for best experience on mobile
        </p>
      </div>
    </>
  );
