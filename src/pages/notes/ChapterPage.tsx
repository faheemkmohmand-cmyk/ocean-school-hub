...
function buildSrcDoc(code: string): string {
  ...
  if (isP5) {
    // p5 GLOBAL MODE — the only correct way:
    // 1. Load p5.js as first script (defines window.p5 internals)
    // 2. Load sketch as second script (defines window.setup, window.draw etc.)
    // 3. p5 auto-detects those globals and starts the sketch loop
    // NO interceptor, NO IIFE, NO instance wrapping — all of those break it
    return [
