...
function buildSrcDoc(code: string): string {
  ...
  // Three.js detected by THREE keyword
  ...
  const head = [
    ...
    'html,body{width:100%;height:100%;overflow:hidden;background:#0a0a1a;display:block}',
    // Canvas appended by Three.js to body — make it fill the viewport
    'canvas{position:fixed!important;top:0!important;left:0!important;width:100%!important;height:100%!important;display:block!important;outline:none;touch-action:none}',
    '</style>',
    '</head><body>',
  ].join('');
  ...
  return [
    head.replace('background:#0a0a1a','background:#f8f9ff'),
    '<script>',
    safe,
    '</script>',
    '</body></html>',
