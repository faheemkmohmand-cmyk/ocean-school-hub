...
const AdminNotes = () => {
  ...
  // SRS panel state — fetch userId once here so it's ready inside the view
  ...
  if (view==="subjects" && !editingSubject) return (
    <div className="space-y-5">
      ...
      {srsOpen && (
        <div className="rounded-2xl border border-violet-200 dark:border-violet-800/50 bg-violet-50/40 dark:bg-violet-900/10 p-4">
          {srsUserId ? (
