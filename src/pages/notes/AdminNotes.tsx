...
function wrapP5Code(code: string): string {
  ...
  // Escape </script> tags inside the user's code
...
<script>
// Intercept setup to auto-size canvas to fill the preview iframe
const _userSetup = window.setup;
window.setup = function() {
  if (typeof _userSetup === 'function') {
    _userSetup();
...
const _userWR = window.windowResized;
window.windowResized = function() {
  resizeCanvas(windowWidth, windowHeight);
  if (typeof _userWR === 'function') _userWR();
};
</script>
<script>
${safeCode}
