...
function buildSrcDoc(code: string): string {
  ...
  if (isP5) {
    // p5 GLOBAL MODE:
    // Load p5 first, then sketch. p5 auto-calls window.setup + window.draw.
    // Two CDN sources for reliability — tries cdnjs first, unpkg as fallback.
    return [
      commonHead,
      '<script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.9.4/p5.min.js"></script>',
      '<script>',
      // Resize canvas to fit iframe on windowResized
