...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// InteractiveIframe — uses srcdoc (synchronous, no blob URL, no async timing)
// srcdoc is set directly from buildSrcDoc() output — renders immediately on
// first paint. No useEffect, no blob creation, no revoke race conditions.
// The iframe's own origin handles the p5.js CDN script load separately.
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
const InteractiveIframe = ({ code, subjectColor }: { code: string; subjectColor: string }) => {
  ...
  // Build HTML synchronously — no async, no blob URLs, no race conditions
