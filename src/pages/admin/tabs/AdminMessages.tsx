              ...
              filteredConvs.map(conv => (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 p-1.5 rounded-lg bg-destructive/10 hover:bg-destructive/20 text-destructive transition-all"
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-secondary/20">
                {loadingMsgs ? (
                  ...
                  <div key={msg.id} className={`group flex items-end gap-2 ${msg.is_admin_reply ? "justify-end" : "justify-start"}`}>
                    {!msg.is_admin_reply && (
                      <button onClick={() => deleteMessage(msg.id)} title="Delete"
                        className="opacity-0 group-hover:opacity-100 p-1 rounded-lg hover:bg-destructive/10 text-destructive transition-all mb-5 shrink-0">
                        <Trash2 className="w-3.5 h-3.5" />
                      </button>
                    )}
