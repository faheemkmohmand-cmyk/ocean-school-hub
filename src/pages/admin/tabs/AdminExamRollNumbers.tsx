...
const AdminExamRollNumbers = () => {
  ...
  const exportAttendancePDF = () => {
    ...
    autoTable(doc, {
      ...
      body: tableBody,
      headStyles: { fillColor: [245, 245, 245], textColor: [60, 60, 60], fontStyle: "bold", fontSize: 8, halign: "center", cellPadding: 3.5, lineWidth: 0.3, lineColor: [200, 200, 200] },
      bodyStyles: { fontSize: 9, cellPadding: 3, valign: "middle", textColor: [40, 40, 40] },
      columnStyles: {
        0: { cellWidth: 12, halign: "center" },
        1: { cellWidth: 22, halign: "center" },
        2: { cellWidth: 26, halign: "center", fontStyle: "bold" },
        3: { cellWidth: 60, halign: "left", overflow: "ellipsize" },
      ...
      didParseCell: (data: any) => {
        if (data.section === "body" && data.column.index === 4) {
          ...
          if (val === "Present") { data.cell.styles.textColor = [40, 40, 40]; data.cell.styles.fontStyle = "bold"; }
          else if (val === "Absent") { data.cell.styles.textColor = [80, 80, 80]; data.cell.styles.fontStyle = "normal"; }
          else if (val === "Leave") { data.cell.styles.textColor = [120, 120, 120]; data.cell.styles.fontStyle = "italic"; }
        }
      },
