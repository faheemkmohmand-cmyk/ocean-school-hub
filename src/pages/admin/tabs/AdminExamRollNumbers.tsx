  ...
  return (
    <div className="space-y-3">
      {!active ? (
        ...
        <div className="space-y-3">
          <div id={containerIdRef.current} className="w-full rounded-xl bg-black border-2 border-emerald-400/50" style={{ minHeight: 250, contain: "layout style" }} />
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="ml-auto">
          <div className="flex gap-1 bg-secondary/50 rounded-xl p-1">
            <button onClick={() => setMainTab("rolls")} className={`px-4 py-2 rounded-lg text-xs font-semibold transition-colors ${mainTab === "rolls" ? "bg-card text-foreground shadow-sm" : "text-muted-foreground"}`}>
              <Hash className="w-3.5 h-3.5 inline mr-1" />Roll Numbers
            </button>
            <button onClick={() => setMainTab("attendance")} className={`px-4 py-2 rounded-lg text-xs font-semibold transition-colors ${mainTab === "attendance" ? "bg-card text-foreground shadow-sm" : "text-muted-foreground"}`}>
