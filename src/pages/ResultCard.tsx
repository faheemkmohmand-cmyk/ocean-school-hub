...
const ResultCard = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      let query = supabase
        .from("results")
        .select("id, class, exam_type, year, total_marks, obtained_marks, percentage, grade, is_pass, remarks, exam_roll_no, position, students(full_name, roll_number, father_name, photo_url)")
