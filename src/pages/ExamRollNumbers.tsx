...
const ExamRollNumbers = () => {
  ...
  const downloadMySlip = async (r: RollEntry) => {
    ...
    try {
      ...
      doc.rect(4, 4, pageW - 8, 26, "F");
      doc.setFillColor(180, 180, 180);
      doc.rect(4, 30, pageW - 8, 1.5, "F");
      ...
      const qrDataURL = await QRCode.toDataURL(qrData, { width: 400, margin: 1, errorCorrectionLevel: "M", color: { dark: "#000000", light: "#FFFFFF" } });
      doc.setDrawColor(0, 0, 0);
