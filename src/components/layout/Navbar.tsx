            ...
            <>
              {user ? (
                <>
                  ...
                  <button
                    onClick={signOut}
                    className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors"
                    title="Sign Out"
                  >
                    ...
                    {user ? (
                      <>
                        {isAdmin && (
                          <Link
                            to="/admin"
                            onClick={() => setOpen(false)}
                            className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium bg-amber-500 text-white w-full"
                          >
                            <Shield className="w-4 h-4" />
                            Admin Panel
                          </Link>
                        ...
                        <Link
                          to="/dashboard"
                          onClick={() => setOpen(false)}
                          className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium gradient-accent text-primary-foreground w-full"
                        >
                          <LayoutDashboard className="w-4 h-4" />
                          Dashboard
                        </Link>
                        <button
                          ...
                          className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-destructive hover:bg-destructive/10 w-full text-left transition-colors"
                        >
                          <LogOut className="w-4 h-4" />
                          Sign Out
                        </button>
                      ...
                      <>
                        <Link
                          to="/auth/signin"
                          onClick={() => setOpen(false)}
                          className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-muted-foreground hover:bg-secondary w-full"
                        >
                          <LogIn className="w-4 h-4" />
                          Sign In
                        </Link>
