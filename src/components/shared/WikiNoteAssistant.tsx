...
const WikiNoteAssistant = ({
  ...
  const css = `
    .wna-fab {
      position:fixed; bottom:88px; right:16px; z-index:45;
    ...
    .wna-panel {
      position:fixed; bottom:88px; right:16px; z-index:46;
    ...
    .wna-panel-min { max-height:58px!important; overflow:hidden; }
    .wna-header {
    ...
    .wna-body { flex:1; overflow-y:auto; padding:12px 13px; display:flex; flex-direction:column; gap:10px; }
    /* search row */
